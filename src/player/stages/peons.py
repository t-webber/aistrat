...
def explore(pawns:list[Pawn], player, token, eknights:list[Knight], ecastles:list[Castle], otherunits=[], reste_gold=()):
    """ 
...
def explore_knight(units:list[Knight], player, token, eknights:list[Knight], ecastles:list[Castle], otherunits=[]):
    """ 
